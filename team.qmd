...
<div class="profile-container">
  ...
  <div class="profile-card">
    <div class="profile-image">
      <img src="images/NTL.jpg" alt="Nathan Terseleer Lillo">
    </div>
    <h3 class="profile-name">
      <span class="first-name">Nathan</span>
      <span class="last-name">Terseleer Lillo</span>
    </h3>
    <p class="profile-title">TEP Lover</p>
    <div class="profile-links">
      <a href="mailto:nathan.terseleerlillo@naturalsciences.be?"><i class="fa-solid fa-envelope"></i></a>
